...
$sql = "SELECT * FROM yy_users WHERE ustatus<-1";
...
//        print_r($ids[$i]);die;
        $sql = 'update yy_users set ustatus=1,freeze_time="0000-00-00 00:00:00",unfreeze_time="0000-00-00 00:00:00" where id=' . $ids[$i]['id'];
        $conn->query($sql);
