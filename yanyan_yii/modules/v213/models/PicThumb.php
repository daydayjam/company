...
class PicThumb extends \app\components\ActiveRecord{ // class start
    ...
    */
    public function create_thumb($source, $dest){
    	ini_set('gd.jpeg_ignore_warning', true);//防止jpeg创建出来的缩略图是黑的
        ini_set("memory_limit", "128M");//防止图片太大导致无法走下去
      // 检查使用的handler是否已安装
